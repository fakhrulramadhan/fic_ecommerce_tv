...
// equalitty di listptroduct model, product dan attributes
//akan mengecek datanya, kalau datanya sama dan objeknya sama, maka dieksekusi
//pakai equality, wrap generate with equality
...
//Product itu aslinya data product
class Product {
  int? id;
  ...
  bool operator ==(Object other) {
    ...
    return other is Product && other.id == id && other.attributes == attributes;
  }
